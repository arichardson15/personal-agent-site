...
const FooterBanner = forwardRef<HTMLDivElement, FooterBannerProps>((props, ref) => {
    const navigation = {
        main: [
    ...
    return (
        <footer className="w-full bottom-0 left-0 bg-tertiary max-h-full">
            <div className="mx-auto bg-tertiary max-w-7xl overflow-hidden px-6 py-10 lg:px-8">
